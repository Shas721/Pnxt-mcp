...
from services.auth_session import AuthSession, clear_session, current_user, get_session, set_session

def create_authenticated_session(payload: dict[str, Any], login_method: str) -> AuthSession:
